...
if (localStorage.product10 == "undefined" || localStorage.product10 == null){localStorage.product10 = ProductToJSON(product10);}
if (localStorage.product11 == "undefined" || localStorage.product11 == null){localStorage.product11 = ProductToJSON(product11);}
...
function GetAllProducts()
{
	...
	array[10] = JSON.parse(localStorage.product10);
	array[11] = JSON.parse(localStorage.product11);
	return array;
}
