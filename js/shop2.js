// Lấy tất cả sản phẩm từ localStorage và hiển thị lên trang shop2.html
	...
	content += '<div class="col-md-3 col-sm-6">';
		content += '<div class="single-shop-product">';
			...
			content += '<div class="product-option-shop">';
				content += '<a onclick="AddToCartIndex('+i+')" class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="cart2.html">Thêm vào giỏ hàng</a>';
			content += '</div>';
