...
/* -------------------------------------------------------------- 
* Hiển thị các thông tin sản phẩm lên trang single-product2.html * 
--------------------------------------------------------------- */
// Thanh tiêu đề
...
for (var i = 0;i<5;i++)
{
	content += '<li><a onclick="ChangeIdForSingleProduct('+i+')" href="single-product2.html">'+products[i].name+'</a></li>';
}
content += '</ul>';
